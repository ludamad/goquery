...
/*
#cgo CFLAGS: -Ilua
#cgo llua LDFLAGS: -lluajit
#cgo luaa LDFLAGS: -lluajit -lm -ldl
#cgo linux,!llua,!luaa LDFLAGS: -lluajit -lm -ldl
#cgo darwin,!luaa LDFLAGS: -lluajit
#cgo freebsd,!luaa LDFLAGS: -lluajit
